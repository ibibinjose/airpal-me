      ...
      <section id="top" className="hero-section">
        ...
        <div className="hero-grid">
          <div className="hero-copy">
            ...
            <div className="hero-actions"><button className="button-primary" onClick={() => setLocation("/os")}>Open the travel OS <ArrowRight size={17} /></button><button className="button-quiet" onClick={() => setLocation("/stay")}>Hotel companion</button><button className="button-quiet" onClick={() => setLocation("/campus")}>College companion</button></div>
